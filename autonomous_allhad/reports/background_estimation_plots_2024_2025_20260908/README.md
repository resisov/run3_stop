...
Strict lepton veto pT > 10 GeV 및 Low-dM double-ratio 하한 250 GeV 결과입니다.

2025 플롯은 2026-09-11 승격된 새 Top/W SF 히스토그램으로 재측정한 결과입니다. 2024 플롯은 이전 결과이며 새 Top/W 입력 승격을 기다립니다. 두 연도가 모두 새 SF로 갱신된 것으로 해석하면 안 됩니다.
...
- 기존 plot_recoil_transfer_factors_2024.py를 재사용합니다. 2025는 새 히스토그램 유래 TF 입력으로 재측정·그린 결과이며, 저장된 TF JSON의 --plot-only 재렌더링은 측정값을 변경하지 않습니다.
- 모음 폴더의 카테고리별 낱장 복사본을 통합 그림으로 교체했습니다. 2025 원본 측정은 새 입력 해시의 결과로 갱신됐고, 2024는 변경하지 않았습니다.
