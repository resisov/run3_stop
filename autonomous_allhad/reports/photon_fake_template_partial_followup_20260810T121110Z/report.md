...
|---|---:|---:|---:|---:|---:|
| photon_fake_template_partial_followup_20260810T121110Z | incomplete | 1544/5795 | 13370/13370 | 3418425431 | 393225 |
...
|---|---|---|
| EB_pt220to300 | EB_pt220to300 | 1.95 ± 1.08 (stat.) ± 0.0806 (syst.) |
| EB_pt300to400 | EB_pt220to400 | 2.234 ± 0.894 (stat.) ± 0.237 (syst.) |
| EB_pt400to600 | EB_inclusive | 1.632 ± 0.576 (stat.) ± 0.228 (syst.) |
| EB_pt600toinf | EB_inclusive | 1.632 ± 0.576 (stat.) ± 0.228 (syst.) |
| EE_pt220to300 | EE_pt220to400 | 6.454 ± 4.65 (stat.) ± 2.16 (syst.) |
| EE_pt300to400 | EE_pt220to400 | 6.454 ± 4.65 (stat.) ± 2.16 (syst.) |
| EE_pt400to600 | EE_inclusive | 4.683 ± 2.77 (stat.) ± 1.49 (syst.) |
| EE_pt600toinf | EE_inclusive | 4.683 ± 2.77 (stat.) ± 1.49 (syst.) |
...
- MC high-$\Delta\phi$ closure: prediction/truth = 46.655586249543795; $\chi^2$/ndf = 0.9395339612002219.
- Independent data high-$\Delta\phi$ closure: prediction/direct fit = -20.423468444327753; $\chi^2$/ndf = 4.005779325906621.
- Nominal GCR validation: prediction/direct fit = -25.452453778999875; $\chi^2$/ndf = 0.0005054701030707352.
...
The integral Data/MC ratio is 1.416 for nominal MC and 1.743 after replacing the nominal fake component. All three predeclared shape metrics improve: False.
...
- [EB_pt220to400: pass fit](plots/fit_EB_pt220to400_pass.png)
- [EB_pt220to400: loose fit](plots/fit_EB_pt220to400_loose.png)
