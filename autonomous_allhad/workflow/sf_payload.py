...
The measurement directories write fit/count results first.  Only results whose
status is explicitly ``adopted`` may be installed below ``analysis/data``.
This keeps preliminary measurements from silently entering nominal weights.
"""
