#!/usr/bin/env python3
"""Build J/psi tag-and-probe histograms for 5--10 GeV loose muons."""
...
def main() -> int:
    ...
    payload = build_histograms(kind="muon", data_files=read_file_list(args.data_files), mc_files=read_file_list(args.mc_files), config=json.loads(args.config.read_text()), repo=Path.cwd().resolve(), step_size=args.step_size)
