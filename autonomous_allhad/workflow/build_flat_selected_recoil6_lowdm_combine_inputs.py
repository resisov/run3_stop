...
SELECTED_RECOIL6_SCHEME = "boosted_an17_selected_recoil6_SR"
SELECTED_RECOIL6_CHANNEL = "cat7_SR_selected_an17_recoil6"
MIN_BIN = 1.0e-9
...
def selected_lowdm_datacard_text(
    ...
    return text.replace(
        ...
        "high-dM SR uses the selected 7 x 6 recoil category bins; "
...
def main() -> int:
    ...
    manifest = {
        ...
        "schema": "flat_selected_an17_recoil6_plus_lowdm_sr_v1" if include_lowdm else "flat_selected_an17_recoil6_sr_v1",
        ...
        "selected_recoil6_policy": "Requested AN17 bins 4,5,8,9,14,15,16 are expanded into six recoil bins each, ordered by the plotted category blocks.",
