...
export AUTONOMOUS_ALLHAD_FULL_SHARD_SIZE=2
export AUTONOMOUS_ALLHAD_FULL_RECORD_SCOPE=data
export AUTONOMOUS_ALLHAD_PRODUCTION_TAG=sf_unc_v2_data2_20260622
