...
# ----- unpack conda env locally (no 'source activate') -----
...
# ----- stage-out: copy futures to a fixed name at WORKDIR root -----
FUT="hists/btageff2024/${DATASET}.futures"
echo "=== Locate futures ==="
ls -lah "hists/btageff2024" || true
