...
NOMINAL_FILE = f"{HIST_DIR}/stop_{YEAR}_nominal.scaled"

METUNCL_UP_FILE = f"{HIST_DIR}/stop_{YEAR}_metUnclusteredUp.scaled"
METUNCL_DOWN_FILE = f"{HIST_DIR}/stop_{YEAR}_metUnclusteredDown.scaled"

JES_UP_FILE = f"{HIST_DIR}/stop_{YEAR}_jesTotalUp.scaled"
JES_DOWN_FILE = f"{HIST_DIR}/stop_{YEAR}_jesTotalDown.scaled"
